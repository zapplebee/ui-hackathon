...
const secondaryCls = twStub(
  "border-vela-cyan bg-vela-coal text-vela-cyan hover:border-vela-cyan hover:bg-vela-cyan hover:text-vela-coal focus:border-vela-cyan focus:bg-vela-cyan focus:text-vela-coal disabled:cursor-not-allowed disabled:hover:bg-vela-coal disabled:border-vela-coal-light disabled:text-vela-coal-light",
);
